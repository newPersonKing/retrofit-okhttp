...
import com.xsb.myupload.okhttp.ProgressHelper;
import com.xsb.myupload.okhttp.ProgressUIListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
         path= Environment.getExternalStorageDirectory()+"/DCIM/Camera/20180708_172640.jpg";
         file=new File(path);
//        for (File file1:file.listFiles()){
//            Log.i("ccccccccccc","file=="+file1.getAbsolutePath());
//        }
    }
    ...
    private void upload() {
        ...
        String url = "http://10.10.10.80:8080/testuploadimg";
        ...
        bodyBuilder.addFormDataPart("test", apkFile.getName(), RequestBody.create(MediaType.parse("application/octet-stream"), apkFile));
